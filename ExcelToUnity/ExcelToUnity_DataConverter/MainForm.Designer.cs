namespace ExcelToUnity_DataConverter
{
    partial class MainForm
    {
	    ...
	    private void InitializeComponent()
	    {
		    ...
		    this.toolTip.SetToolTip(this.txtUnminimizeFields, "Type the name of the column in the json data sheet that you want to export even i" + "f it has no values.\r\nSeparate each field with a comma ‘;’");
		    ...
		    this.toolTip.SetToolTip(this.txtSettingExcludedSheet, "Type the name of the sheet that you want to skip when exporting. The skipped shee" + "t will still be processed but not exported.\r\nSeparate each sheet with a comma ‘;" + "’");
		    ...
		    this.toolTip.SetToolTip(this.txtLanguageMaps, "Type the name of the language you want to localize. The tool will extract all uni" + "que characters for each language and export them to a txt file.\r\nSeparate each l" + "anguage with a comma ‘;’");
		    ...
		    this.toolTip.SetToolTip(this.chkKeepOnlyEnumAsIds, "In the IDs sheet, ID columns with the [enum] tag will only export data in enum fo" + "rm!");
		    ...
		    // statusStrip2
		    // 
		    this.statusStrip2.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.txtVersion, this.toolStripStatusLabel3 });
		    ...
		    this.DtgFilePaths.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] { this.path, this.exportIds, this.exportConstants, this.status, this.BtnDelete });
		    ...
		    this.DtgSheets.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] { this.SheetName, this.Check });
		    ...
		    this.DtgGoogleSheets.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] { this.GoogleSheetName, this.GoogleSheetId, this.BtnEditGoogleSheet, this.BtnDeleteGoogleSheet });
